...
export default function LoginPage() {
  ...
  return (
    <main className="w-full max-w-md z-10 mx-auto mt-20 md:mt-32 px-4 relative">
      ...
      <div className="bg-surface dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-mosque/20 backdrop-blur-sm relative z-10">
