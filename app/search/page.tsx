    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        <div className="flex items-center text-sm text-nordic-muted mb-4">
          ...
          <span className="text-nordic-dark font-medium">Search Results</span>
        </div>
      ...
      {properties.length > 0 ? (
        ...
        <div className="text-center py-20 bg-white rounded-2xl border border-nordic-dark/5">
          ...
          <p className="text-nordic-muted max-w-md mx-auto">
            We couldn't find any properties matching your current search criteria. Try adjusting your filters or expanding your search area.
          </p>
          <Link 
            href="/"
