      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <main className="pointer-events-auto relative w-full max-w-2xl bg-white dark:bg-gray-900 rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <header className="px-8 py-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-white dark:bg-gray-900 sticky top-0 z-30">
            <h1 className="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">{t('filters_modal.title')}</h1>
            <button 
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar p-8 space-y-10">
            {/* Section 1: Location */}
            <section>
              <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3">{t('filters_modal.location')}</label>
              <div className="relative group">
                ...
                <input 
                  ...
                  placeholder={t('filters_modal.location_placeholder')} 
                  type="text" 
                  value={location}
            ...
            <section>
              <div className="flex justify-between items-end mb-4">
                <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t('filters_modal.price_range')}</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-nordic-light dark:bg-gray-800 p-3 rounded-lg border border-transparent focus-within:border-mosque/30 transition-colors">
                  <label className="block text-[10px] text-gray-500 uppercase font-medium mb-1">{t('filters_modal.min_price')}</label>
                ...
                <div className="bg-nordic-light dark:bg-gray-800 p-3 rounded-lg border border-transparent focus-within:border-mosque/30 transition-colors">
                  <label className="block text-[10px] text-gray-500 uppercase font-medium mb-1">{t('filters_modal.max_price')}</label>
                  <div className="flex items-center">
                    <span className="text-gray-400 mr-1">$</span>
                    <input 
                      className="w-full bg-transparent border-0 p-0 text-gray-900 dark:text-white font-medium focus:ring-0 text-sm" 
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t('filters_modal.property_type')}</label>
                <div className="relative">
                  ...
                  >
                    <option value="Any Type">{t('filters_modal.any_type')}</option>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{t('filters_modal.bedrooms')}</span>
                ...
                {/* Baths */}
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{t('filters_modal.bathrooms')}</span>
                  <div className="flex items-center space-x-3 bg-nordic-light dark:bg-gray-800 rounded-full p-1">
                    <button 
            ...
            {/* Section 4: Amenities */}
            <section>
              <label className="block text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">{t('filters_modal.amenities')}</label>
