    ...
    <section className="py-12 md:py-16">
      <div className="max-w-3xl mx-auto text-center space-y-8">
        ...
        <div className="relative group max-w-2xl mx-auto">
          ...
          />
          <button className="absolute right-2 top-2 bottom-2 px-6 bg-mosque hover:bg-mosque/90 text-white font-medium rounded-lg transition-colors flex items-center justify-center shadow-lg shadow-mosque/20">
            Search
          </button>
        </div>
